                  ...
                  {lineas.map((l, i) => {
                    ...
                    return (
                      <tr key={l.nombre} className={`cursor-pointer transition-colors hover:bg-blue-50 ${i % 2 === 0 ? "bg-white" : "bg-gray-50/70"}`}>
                        <td className="px-2 py-2 text-sm font-normal text-gray-900">
                          {link ? <Link href={link} className="hover:underline text-gray-900">{l.nombre}</Link> : l.nombre}
                        </td>
                        <td className="px-2 py-2 text-center text-sm font-medium text-gray-900 tabular-nums">{fmt(l.primaNeta)}</td>
                        <td className="px-2 py-2 text-center text-sm font-medium text-gray-800 tabular-nums">{fmt(l.anioAnterior)}</td>
                        <td className="px-2 py-2 text-center text-sm font-medium text-gray-600 tabular-nums">{fmt(l.presupuesto)}</td>
                        <td className={`px-2 py-2 text-center text-sm font-medium tabular-nums ${diffColor}`}>
